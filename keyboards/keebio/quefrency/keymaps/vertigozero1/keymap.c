...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT_65_with_macro(BL_STEP, BL_TOGG, KC_GRV,  KC_F1,  KC_F2,    KC_F3,   KC_F4,   KC_F5,   KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_DEL, KC_DEL, _______, 
							   ...
							   BL_OFF,  BL_DEC,  KC_CAPS, _______, _______, DEGREE, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, 
	...
	[2] = LAYOUT_65_with_macro(RGB_MOD, RGB_TOG, _______, INVBANG, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, 
							   RGB_SPI, RGB_VAI, _______, _______, SNEK, _______, REGIST, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, 
							   ...
							   RGB_SAI, RGB_HUI, _______, _______, COPYRIGHT, _______, _______, _______, _______, _______, IRONY, INTERROBANG, PREGUNTA, _______, _______, _______, 
